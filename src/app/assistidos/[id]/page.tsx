    ...
    <main className="min-h-screen bg-[var(--light)] p-4">
      ...
      <div className="flex flex-wrap">
        ...
        <div className="p-4 bg-[var(--light)] w-1/3 p-2 border-2 border-[var(--white)]">
          ...
          <div className="flex gap-2 flex-wrap">
            <InfoField name="Nome da mãe" info="Maria Regina Turino Da Silva" />
        ...
        <div className="flex justify-between gap-4">
          ...
          >
            ...
            <textarea
              ...
              style={{ width: "300px" }}
            />
            <input type="submit" value="Adicionar" className="px-4 py-2 w-full border-2 border-[var(--dark)] rounded-xl font-bold bg-[var(--medium)] text-[var(--dark)] hover:bg-[var(--dark)] hover:text-[var(--orange)] hover:border-[var(--orange)] transition duration-400" />
          </form>
        </div>
      </div>
    </main>
